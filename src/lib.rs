    ...
    pub fn execute(
        ...
        loop {
            ...
            ret_val = match cmd[0] {
                ...
                "insert" => butterfly::map(memory, vars, self, cmd, statement),
                "delete" => butterfly::map(memory, vars, self, cmd, statement),
                "get" => butterfly::map(memory, vars, self, cmd, statement),
